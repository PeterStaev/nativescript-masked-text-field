...
const maskedTextFieldMangleExcludes = require("nativescript-masked-text-field/uglify-mangle-excludes").default;
...
module.exports = env => {
    ...
    if (uglify) {
        ...
        config.plugins.push(new webpack.optimize.UglifyJsPlugin({
            mangle: { except: nsWebpack.uglifyMangleExcludes.concat(maskedTextFieldMangleExcludes) },
            compress,
        }));
    }
    return config;
